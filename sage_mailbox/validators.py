...
class FolderNameValidator:
    ...
    def __eq__(self, other):
        return (
            isinstance(other, FolderNameValidator) and
            self.length_error_message == other.length_error_message and
            self.character_error_message == other.character_error_message and
